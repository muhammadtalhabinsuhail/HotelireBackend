...
<body>
  <div class="wrapper">
    <div class="container">
      ...
      <!-- Content -->
      <div class="content">
        <h2 class="content-title">Congratulations, ${ownerName}!</h2>
        <p class="content-text">
          Thank you for trusting <strong>Hotelire</strong> and completing your subscription successfully.
          You’ve taken a powerful step forward — and we truly appreciate your commitment.
        </p>

        <div class="highlight-box">
          <div class="highlight-title">Your Property Is Now Live</div>
          <p class="highlight-text">
            Your listed properties are now <strong>publicly visible</strong> and can be booked by customers
            from around the world. This means your journey toward consistent earnings has officially begun.
          </p>
        </div>
        ...
        <p class="content-text" style="font-size: 14px; color: #666;">
          You’ve done an excellent job setting everything up.
          We’re excited to support you as you grow your business with Hotelire.
        </p>
      </div>
